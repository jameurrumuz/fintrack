...
import { subscribeToAllTransactions, deleteTransaction, toggleTransaction } from '@/services/transactionService';
                        ...
                        <AlertDialogTrigger asChild>
                         ...
                         <AlertDialogContent>
                            ...
                            <AlertDialogFooter><AlertDialogCancel>Cancel</AlertDialogCancel><AlertDialogAction onClick={() => {
                                // Individual delete for each selected - you can implement bulk delete if needed
